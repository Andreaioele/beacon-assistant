...
#
#     PHX_SERVER=true bin/beacon_assistant start
#
...
if config_env() == :prod do
  ...
  config :beacon_assistant, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :beacon_assistant, BeaconAssistant.Mailer,
